...
// share WhatsApp
  ...
  if ($uprofile != "") {
    $waprofile = "Paket      : *" . $uprofile . "* %0A";
  } else {
    $waprofile = "Paket      : *Non Paket.* %0A";
  }
...
$shareWAUP = ".%0A
*Voucher Digital*%0A
Hotspot *" . $hotspotname . "*%0A
_Via MikhmonV3.20_%0A%0A
----------------------------------%0A
Username : *" . $uname . "* %0A
Password : *" . $upass . "* %0A
----------------------------------%0A
...
----------------------------------%0A
Login disini :%0A
*http://".$dnsname."/login?username=".$uname."%26password=".$upass."* %0A%0A
Cek Status :%0A
*http://".$dnsname."/status* %0A%0A
Terimakasih.
";
$shareWAVC = ".%0A
*Voucher Digital*%0A
